---
name: log
description: Quick log of a small change - minimal overhead. Use for small modifications that don't need a full /doc. Adds one line to docs/logs/YYYY-MM-DD.md.
...
Si un argument est fourni, utilise cette description.
Sinon, demande : "Qu'est-ce que tu viens de faire ?"
